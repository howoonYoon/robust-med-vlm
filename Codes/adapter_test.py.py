...
def parse_args():
    ...
    # VLM settings
    p.add_argument("--backend", type=str, default=None, choices=["qwen3", "medgemma", "internvl", "lingshu"])
...
def main():
    ...
    if args.run_vlm:
        if args.backend is None or args.vlm_ckpt is None:
            raise ValueError("--run_vlm requires --backend and --vlm_ckpt")
    ...
    if args.run_vlm:
        ...
        ckpt = torch.load(args.vlm_ckpt, map_location="cpu")
